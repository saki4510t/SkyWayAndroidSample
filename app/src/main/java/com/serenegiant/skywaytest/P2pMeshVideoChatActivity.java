 ...
 *
 */
public class P2pMeshVideoChatActivity extends Activity {
	private static final boolean DEBUG = true;	// set false on production
	private static final String TAG = P2pMeshVideoChatActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mesh_video_chat);
		...
		_peer.on(Peer.PeerEventEnum.OPEN, new OnCallback() {
			...
			public void onCallback(Object object) {
				...
				saveAPIKey(P2pMeshVideoChatActivity.this, option.key);
				// Show my ID
		...
		final String room
			= activity.getPreferences(Context.MODE_PRIVATE)
				.getString(PREF_KEY_ROOM_MESH, null);
	...
	void joinRoom() {
		...
		getPreferences(Context.MODE_PRIVATE)
			.edit()
			.putString(PREF_KEY_ROOM_MESH, roomName)
			.apply();
		...
		_room.on(Room.RoomEventEnum.OPEN, new OnCallback() {
			...
			public void onCallback(Object object) {
				...
				Toast.makeText(P2pMeshVideoChatActivity.this, "Enter Room: " + roomName, Toast.LENGTH_SHORT).show();
			}
		});
		...
		_room.on(Room.RoomEventEnum.CLOSE, new OnCallback() {
			...
			public void onCallback(Object object) {
				...
				Toast.makeText(P2pMeshVideoChatActivity.this, "Leave Room: " + roomName, Toast.LENGTH_LONG).show();
		...
		_room.on(Room.RoomEventEnum.PEER_JOIN, new OnCallback()
		{
			...
			public void onCallback(Object object)
			{
				...
				Toast.makeText(P2pMeshVideoChatActivity.this, peerId + " has joined.", Toast.LENGTH_LONG).show();
			}
		});
		_room.on(Room.RoomEventEnum.PEER_LEAVE, new OnCallback()
		{
			...
			public void onCallback(Object object)
			{
				...
				Toast.makeText(P2pMeshVideoChatActivity.this, peerId + " has left.", Toast.LENGTH_LONG).show();
